...
1. Wat is de meest gebruikte opdeling voor ondernemingen?
    ...
    * Grote ondernemingen
1. Dé definitie van de KMO bestaat niet, in België zijn er al 51 verschillende definities. Deze definities gebruiken vaak drie elementen die van belang zijn. Welke zijn die in de wet van 17 juli 1975, art. 12?
    * < 50 werknemers
    * Jaaromzet excl. BTW <= €9.000.000
    * Balanstotaal <= €4.500.000
1. Wat is de definitie van een KMO in het sociaal recht?
    * Een KMO is een onderneming waarbij het gemiddeld aantal werknemers kleiner is dan 50 personen
1. Wat is de juridische indeling van ondernemingen?
    * Eenmanszaken (zelfstandigen)
    * Vennootschappen
1. Wat zijn de voor- en nadelen van een kleine onderneming?
    * Voordelen:
